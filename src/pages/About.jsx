    ...
    <div className="min-h-screen bg-white py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">About Foundry</h1>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 mb-1">Report Lost Items</h3>
                    <p className="text-gray-600">Submit detailed information about your lost item including description, location, and contact details.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 mb-1">Submit Found Items</h3>
                    <p className="text-gray-600">Help others by reporting items you've found around campus with location and storage information.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 mb-1">Browse & Connect</h3>
                    <p className="text-gray-600">Search through listings and contact owners/finders to arrange item returns.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Easy-to-use submission forms</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Real-time item updates</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-gray-700">Secure contact system</span>
                </div>
              </div>
            </div>
          </div>
