          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">support@foundry.university.edu</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Mon-Fri, 9:00 AM - 5:00 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white mb-1">In-Person Support</h3>
                    <p className="text-gray-600 dark:text-gray-300">Campus Security Office</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Building A, Room 101</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-medium text-gray-900 dark:text-white mb-2">How long do you keep lost items?</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Items are kept for 90 days. After that, they're donated to local charities.</p>
                </div>
                
                <div>
                  <h3 className="font-medium text-gray-900 dark:text-white mb-2">What information should I include in my report?</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Include detailed descriptions, photos if possible, and specific locations/times.</p>
                </div>
                
                <div>
                  <h3 className="font-medium text-gray-900 dark:text-white mb-2">How do I claim a found item?</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Contact the person who submitted the found item report through our secure messaging system.</p>
                </div>
              </div>
            </div>
          </div>
